...
%             T5_1 = R5_1/C;
            ...
            EQ = diag([T2_1_fangcha;T3_1_fangcha;T6_1_fangcha;T7_1_fangcha]);  % Q矩阵为一对角阵
            % Za的第一次WLS估计
...
%             R50 = distance(X5,Y5,x0,y0);
            ...
            Ga0 = -[X2_1,Y2_1,Rab(R20,R10);X3_1,Y3_1,Rab(R30,R10);X6_1,Y6_1,Rab(R60,R10);X7_1,Y7_1,Rab(R70,R10)];
...
%                        R4_1 - (R40 - R10);
        ...
        dd(i) = sgma/C;
        loc_err_Taylor5(i) = mean(err_taylor);   
   end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %Fang定位算法 
for i = 1:num
...
%5个基站
plot(dd,loc_err_Chan5,'k+-'); hold on; 
plot(dd,loc_err_Taylor5,'kd-','MarkerFaceColor','k'); hold on; 
plot(dd,loc_err_Fang5,'k^-','MarkerFaceColor','k');
xlabel('TDOA误差标准差/s');
ylabel('定位误差均值/m');
